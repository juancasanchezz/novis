              ...
              >
                <div className='relative w-24 h-24 mb-6'>
                  ...
                  <motion.div
                    ...
                    className='absolute inset-2 rounded-full border-b-4 border-emerald-300 border-opacity-80'
                  ></motion.div>
                  ...
                  <div>
                    ...
                    <div className='flex flex-col gap-3'>
                      ...
                      <button
                        ...
                        className='w-full px-6 py-3.5 bg-emerald-600 hover:bg-emerald-700 disabled:bg-slate-300 disabled:cursor-not-allowed text-white font-bold rounded-xl transition-colors flex items-center justify-center group shadow-md'
                      >
                        Recibir estimación{' '}
