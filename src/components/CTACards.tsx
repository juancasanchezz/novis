...
export function CTACards() {
  return (
    <section className='relative py-24 md:py-32 bg-slate-900 overflow-hidden'>
      ...
      {/* Línea decorativa superior con gradiente emerald */}
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
        ...
        >
          <span className='inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-slate-400 text-xs font-bold tracking-widest uppercase mb-5'>
            <Sparkles className='w-3 h-3 text-emerald-400' />
            ¿Listo para el siguiente paso?
          </span>
          <h2 className='text-4xl md:text-5xl font-black text-white tracking-tighter'>
            Hagamos algo{' '}
            <span className='bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-cyan-400'>extraordinario</span>
          </h2>
        </motion.div>
        ...
        <div className='grid md:grid-cols-2 gap-5 lg:gap-6'>
          ...
          <motion.div
            ...
            className='relative rounded-3xl p-8 md:p-12 flex flex-col items-start overflow-hidden group glass-dark hover:border-white/15 transition-all duration-500'
          >
            {/* Partículas de código de fondo */}
            {CODE_PARTICLES.map((p) => (
              <motion.span
                key={p.id}
                className='absolute font-mono text-emerald-400 text-sm font-bold pointer-events-none select-none'
            ...
            {/* Orb de fondo */}
            <div className='absolute -top-20 -right-20 w-48 h-48 bg-emerald-500/8 rounded-full blur-3xl group-hover:bg-emerald-500/15 transition-all duration-700 pointer-events-none' />

            <motion.div
              whileHover={{ rotate: [0, -8, 8, 0] }}
              transition={{ duration: 0.5 }}
              className='relative z-10 w-14 h-14 glass-dark border border-emerald-500/20 rounded-2xl flex items-center justify-center mb-8 group-hover:border-emerald-500/40 transition-all duration-300'
            >
              <Briefcase className='w-7 h-7 text-emerald-400' strokeWidth={1.5} />
            </motion.div>

            <h3 className='relative z-10 text-3xl lg:text-4xl font-black text-white mb-4 tracking-tight leading-tight'>
              Desarrolla tu{' '}
            ...
            <p className='relative z-10 text-slate-400 text-lg mb-10 max-w-sm leading-relaxed font-light group-hover:text-slate-300 transition-colors duration-300'>
            ...
            <Link
              to='/contacto'
              state={{ mode: 'empleo' }}
              className='relative z-10 mt-auto inline-flex items-center px-7 py-3.5 glass-dark border border-white/10 hover:border-emerald-500/40 text-white font-bold rounded-2xl transition-all duration-300 group/btn hover:bg-emerald-500/5'
            >
          ...
          >
            ...
            <div className='absolute inset-0 bg-gradient-to-br from-emerald-900/80 via-emerald-800/60 to-slate-900/80 rounded-3xl border border-emerald-700/30 group-hover:border-emerald-500/40 transition-all duration-500' />
            ...
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              className='relative z-10 w-14 h-14 bg-emerald-950/60 border border-emerald-700/50 rounded-2xl flex items-center justify-center mb-8 group-hover:border-emerald-400/60 transition-all duration-300'
            >
              <MessageSquare className='w-7 h-7 text-emerald-400' strokeWidth={1.5} />
            </motion.div>
            ...
            <p className='relative z-10 text-emerald-100/60 text-lg mb-10 max-w-sm leading-relaxed font-light group-hover:text-emerald-100/80 transition-colors duration-300'>
            ...
            <Link
              to='/contacto'
              state={{ mode: 'general' }}
              className='relative z-10 mt-auto inline-flex items-center px-7 py-3.5 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold rounded-2xl transition-all duration-300 group/btn overflow-hidden shadow-lg shadow-emerald-500/30 hover:shadow-emerald-500/50 hover:-translate-y-0.5'
            >
