  ...
  return (
    <>
      ...
      <div className='bg-white flex flex-col w-full overflow-hidden'>
        {/* 1. HERO DE COMPAÑÍA */}
        <section className='relative bg-slate-50 pt-32 pb-24 md:pt-40 md:pb-32 overflow-hidden border-b border-slate-200'>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
            <motion.div
              ...
              className='max-w-3xl'
            >
              <span className='inline-block py-1.5 px-4 rounded-full bg-emerald-50 text-emerald-700 text-xs font-bold tracking-[0.2em] uppercase mb-6 border border-emerald-200 shadow-sm'>
        ...
        {/* 2. NUESTRA IDENTIDAD */}
        <section className='py-32 bg-white border-b border-slate-100 relative'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10'>
              {pillars.map((pillar, index) => (
                <motion.div
                  ...
                  className='bg-white p-10 md:p-12 border border-slate-200 rounded-[2rem] shadow-sm hover:shadow-xl hover:border-emerald-300 transition-all duration-500 group relative overflow-hidden'
                >
                  <div className='absolute top-0 right-0 w-32 h-32 bg-emerald-50 rounded-bl-[100%] transition-transform group-hover:scale-150 duration-700 ease-out z-0'></div>
                  
                  <div className='relative z-10'>
                    <div className='w-16 h-16 rounded-2xl bg-slate-50 border border-slate-200 flex items-center justify-center mb-8 group-hover:bg-emerald-600 group-hover:border-emerald-600 transition-colors duration-500 shadow-sm'>
                      <pillar.icon
                         strokeWidth={1.5}
                         className='w-8 h-8 text-emerald-600 group-hover:text-white transition-colors duration-500'
                      />
                    </div>
                    <h3 className='text-2xl font-bold mb-4 text-slate-900 tracking-tight'>
                      {pillar.title}
                    </h3>
                    <p className='text-slate-600 leading-relaxed font-medium'>{pillar.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
        ...
        {/* 5. CIERRE CONFIANZA */}
        <section className='py-32 bg-slate-50 text-center px-4 relative overflow-hidden border-b border-slate-200'>
          <div className='absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-emerald-100/60 via-slate-50 to-slate-50 pointer-events-none'></div>
          <div className='max-w-4xl mx-auto relative z-10'>
            <Users className='w-16 h-16 text-emerald-600 mx-auto mb-8 drop-shadow-sm' strokeWidth={1.5} />
